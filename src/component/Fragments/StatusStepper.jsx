...
const StatusStepper = ({ steps, currentStep, statusString, trainingStatus, onFeedback }) => {
        ...
        {steps.map((step, index) => {
          ...
          if (isRejected) {
            ...
            if (index === pelaksanaanPelatihanIndex) {
              ...
              if (currentStep >= lolosSeleksiIndex && (trainingStatus === 'Sedang berlangsung' || trainingStatus === 'Selesai')) {
                isStepCompleted = true;
              }
            }
            ...
            if (index === feedbackPelatihanIndex) {
              ...
              if (currentStep >= lolosSeleksiIndex && trainingStatus === 'Selesai') {
                isStepCompleted = true;
              }
            }
            ...
            if (index > 0 && isStepCompleted && !steps[index - 1].isStepCompleted) {
            ...
            if (index === lolosSeleksiIndex && currentStep >= lolosSeleksiIndex) {
            ...
            <li key={index} className="mb-10 ml-6 relative">
              ...
              {/* Tombol Feedback hanya muncul jika:
                  ...
                  3. Pelatihan sudah selesai (trainingStatus === 'Selesai')
                     ATAU status pendaftaran peserta adalah 'menunggu_feedback'
              */}
              {step === "Feedback Pelatihan" && !isRejected &&
                (trainingStatus === 'Selesai' || currentStep === feedbackPelatihanIndex) && (
                <div className="mt-2">
