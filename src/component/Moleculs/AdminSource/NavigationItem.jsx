// File: src/components/Moleculs/AdminSource/NavigationItem.js
...
const NavigationItem = ({ 
          ...
          <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
            ...
            <div className="ml-6 space-y-1 border-l-2 border-gray-600 pl-4">
              {subItems.map((subItem, index) => (
                ...
                >
                  <div className="flex items-center">
                    <Icon icon={subItem.icon} size="sm" color="currentColor" className="mr-2" />
  ...
  if (onClick) {
    return (
      <button
        onClick={onClick}
        className={`w-full hover:bg-gray-700 px-2 py-2 rounded flex items-center text-white transition-colors ${isActive ? 'bg-gray-700' : ''}`}
      >
        {isOpen ? (
          <>
            <Icon icon={icon} size="md" color="white" className="mr-2" />
