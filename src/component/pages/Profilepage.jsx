...
const ProfilePage = () => {
  ...
  const loadUserProfileAndTrainings = useCallback(async () => {
    ...
    try {
      ...
      if (!currentUserData) {
        console.log(
          "ProfilePage: Data pengguna tidak ada di localStorage atau rusak, mencoba ambil dari API /user."
        );
        ...
        if (response && response.data) {
          ...
          console.log(
            "ProfilePage: Data pengguna dimuat dari API /user:",
            currentUserData
          );
        } else {
      ...
      if (
        ...
        console.log(
          "ProfilePage: Data pendaftaran pelatihan dimuat:",
        ...
        console.log(
          "ProfilePage: Data pendaftaran pelatihan dimuat (paginasi):",
          registeredTrainingsResponse.data.data
        );
      } else {
        console.warn(
          "ProfilePage: Tidak ada data pendaftaran pelatihan atau respons tidak valid:",
          registeredTrainingsResponse
        );
      ...
      console.error(
        "Gagal mengambil data profil atau pendaftaran pelatihan dari API:",
        err
      );
