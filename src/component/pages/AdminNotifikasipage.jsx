...
import { FaPlus, FaEdit, FaTrash, FaClock, FaUser, FaTimes } from 'react-icons/fa';
  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message: "Untuk meningkatkan peluang diterima, pastikan Anda: 1) Memiliki nilai bagus di mata kuliah terkait, 2) Menunjukkan kemampuan komunikasi yang baik, 3) Memiliki pengalaman organisasi, 4) Dapat bekerja dalam tim.",
      type: "Info",
      status: "Terkirim",
    ...
    },
    {
      ...
      message: "Wawancara untuk calon asisten laboratorium akan dilaksanakan pada tanggal 22-26 Januari 2024. Jadwal detail akan dikirimkan melalui email kepada kandidat yang lolos tahap administrasi.",
      type: "Penting",
      status: "Terkirim",
    ...
    },
    {
      ...
      message: "Untuk periode ini, persyaratan minimal IPK untuk menjadi asisten laboratorium adalah 3.25. Pastikan IPK Anda memenuhi kriteria sebelum mendaftar.",
      type: "Perhatian",
      status: "Terjadwal",
    ...
    },
    {
      ...
      message: "Pendaftaran asisten laboratorium untuk semester genap 2024 telah dibuka. Periode pendaftaran dimulai dari tanggal 1 Januari hingga 15 Januari 2024. Pastikan Anda memenuhi semua persyaratan yang telah ditentukan.",
      type: "Info",
      status: "Terkirim",
    ...
    },
    {
      ...
      message: "Sistem pendaftaran akan mengalami pemeliharaan pada tanggal 20 Januari 2025. Harap selesaikan pendaftaran sebelum waktu tersebut.",
      type: "Perhatian",
      status: "Draft",
    ...
    if (editingNotification) {
      ...
      setNotifications(notifications.map(notification => 
        notification.id === editingNotification.id 
          ? { ...newNotification, id: editingNotification.id, createdDate: editingNotification.createdDate }
          : notification
      ));
    } else {
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-bold text-gray-900">
                    {editingNotification ? 'Edit Pengumuman' : 'Buat Pengumuman Baru'}
                  </h2>
                  <button
